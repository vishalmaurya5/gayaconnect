...
export const profileSchema = z.object({
  ...
  workerSkills: z.union([z.array(z.string()), z.string()]).optional(),
  workerPhone: phoneSchema.optional().or(z.literal('')),
  workerAadhaar: optionalSafeText('Aadhaar Number', 12),
  workerBloodGroup: optionalSafeText('Blood Group', 10),
  workerState: optionalSafeText('State', 50),
  workerDistrict: optionalSafeText('District', 50),
  instagram: optionalSafeText('Instagram Link', 300),
  facebook: optionalSafeText('Facebook Link', 300),
