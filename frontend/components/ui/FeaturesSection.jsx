...
export default function FeaturesSection() {
    const features = [
        ...
        { 
            title: 'Trusted Skilled Workforce', 
            description: 'Connect directly with verified daily-wage labourers, technicians, and skilled professionals.', 
            action: 'Hire Professionals', 
            link: '/labour',
        ...
        { 
            ...
            description: 'Discover the best rental properties, office spaces, and real estate in your preferred locations.', 
