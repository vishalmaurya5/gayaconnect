  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">Sell Listings</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage products and items listed for sale by users.</p>
        </div>
      </div>
        ...
        <div className="p-4 md:p-5 border-b border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-50/50 dark:bg-[#05080f]/50">
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <div className="relative flex-1 sm:flex-none">
              ...
              <input 
                type="text" 
                placeholder="Search sell listings..." 
                value={searchInput}
            ...
            >
              <tr>
                <td colSpan="3" className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white">No Sell Listings</h3>
                  <p className="text-slate-500 dark:text-slate-400 mt-1 max-w-sm mx-auto">Items posted for sale will appear here.</p>
                </td>
              </tr>
            </motion.tbody>
          </table>
