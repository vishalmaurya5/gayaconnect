  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">Email Campaigns</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Create and schedule email marketing campaigns.</p>
        </div>
            ...
            >
              <tr>
                <td colSpan="3" className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white">No Email Campaigns</h3>
                  <p className="text-slate-500 dark:text-slate-400 mt-1 max-w-sm mx-auto">Start reaching out to your users with email campaigns.</p>
                </td>
              </tr>
            </motion.tbody>
          </table>
