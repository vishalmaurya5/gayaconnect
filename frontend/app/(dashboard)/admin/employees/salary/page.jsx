  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">Salary Status</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage employee payroll, slips, and payment history.</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-[#0B0F19] rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col">
        ...
        <div className="p-12 flex flex-col items-center text-center">
          ...
          <p className="text-slate-500 mt-1">Generate and view employee salaries here.</p>
        </div>
      </div>
    </div>
  );
