    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage and resolve customer support tickets.</p>
        </div>
      </div>
          ...
          <table className="w-full text-left border-collapse whitespace-nowrap">
            <thead>
              <tr className="bg-white dark:bg-[#0B0F19] border-b border-slate-200 dark:border-slate-800">
                <th className="px-6 py-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Ticket ID / Subject</th>
            ...
            >
              <tr>
                <td colSpan="4" className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white">No Support Tickets</h3>
                  <p className="text-slate-500 dark:text-slate-400 mt-1 max-w-sm mx-auto">Active customer complaints and requests will appear here.</p>
                </td>
              </tr>
            </motion.tbody>
          </table>
