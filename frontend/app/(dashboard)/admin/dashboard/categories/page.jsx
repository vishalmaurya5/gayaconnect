    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage the hierarchy of business categories and sub-categories.</p>
        </div>
      ...
      <div className="bg-white dark:bg-[#0B0F19] rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col">
        <div className="p-4 md:p-5 border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-[#05080f]/50">
          <div className="relative max-w-xs">
            ...
            <input type="text" placeholder="Search categories..." className="w-full pl-9 pr-4 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm outline-none focus:border-indigo-500 transition-all" />
          </div>
        </div>
        <div className="p-12 flex flex-col items-center text-center">
          ...
          <h3 className="text-lg font-bold text-slate-900 dark:text-white">Category Taxonomy</h3>
          <p className="text-slate-500 mt-1">Business categories like Healthcare, Retail, and Services will appear here.</p>
        </div>
      </div>
    </div>
  );
