  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">Login History & Logs</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Audit trail for user authentication events, IP addresses, and session locations.</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-[#0B0F19] rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col">
        <div className="p-4 md:p-5 border-b border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-50/50 dark:bg-[#05080f]/50">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input 
                type="text" 
                placeholder="Search IPs or Emails..." 
        ...
        <div className="p-12 flex flex-col items-center text-center">
          ...
          <h3 className="text-lg font-bold text-slate-900 dark:text-white">Audit Logs Collecting</h3>
          <p className="text-slate-500 mt-1">Authentication logs will appear here as users log in and out of the platform.</p>
        </div>
      </div>
    </div>
  );
