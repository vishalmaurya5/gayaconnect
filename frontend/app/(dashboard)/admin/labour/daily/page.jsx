...
import { 
  Search, Filter, Download, Plus, HardHat, Clock, Calendar
} from 'lucide-react';
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage daily wage workers, active shifts, and daily assignments.</p>
        </div>
        ...
        <div className="p-4 md:p-5 border-b border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-50/50 dark:bg-[#05080f]/50">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <div className="relative flex-1 sm:flex-none">
              ...
              <input 
                type="text" 
                placeholder="Search daily shifts..." 
                value={searchInput}
          ...
          <table className="w-full text-left border-collapse whitespace-nowrap">
            <thead>
              <tr className="bg-white dark:bg-[#0B0F19] border-b border-slate-200 dark:border-slate-800">
                <th className="px-6 py-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Worker Details</th>
                <th className="px-6 py-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Shift Time</th>
                <th className="px-6 py-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Rate / Day</th>
            ...
            >
              ...
              <tr>
                <td colSpan="4" className="p-12 text-center">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 mt-1 max-w-sm mx-auto">Assign workers to daily shifts to see them here.</p>
                </td>
              </tr>
            </motion.tbody>
          </table>
