...
import { 
  Search, Filter, Download, Plus, HardHat, DollarSign, Receipt
} from 'lucide-react';
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage payouts, wages, and financial records for labourers.</p>
        </div>
            ...
            >
              ...
              <tr>
                <td colSpan="5" className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white">No Payment Records</h3>
                  <p className="text-slate-500 dark:text-slate-400 mt-1 max-w-sm mx-auto">Recorded payments and wages will appear here.</p>
                </td>
              </tr>
            </motion.tbody>
          </table>
