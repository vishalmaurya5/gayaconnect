...
import { 
  Search, Filter, Download, Plus, HardHat, CalendarCheck, Clock
} from 'lucide-react';
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Track and manage daily attendance records for the workforce.</p>
        </div>
          ...
          <table className="w-full text-left border-collapse whitespace-nowrap">
            <thead>
              <tr className="bg-white dark:bg-[#0B0F19] border-b border-slate-200 dark:border-slate-800">
                ...
                <th className="px-6 py-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Check In / Out</th>
            ...
            >
              ...
              <tr>
                <td colSpan="4" className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white">No Attendance Logs</h3>
                  <p className="text-slate-500 dark:text-slate-400 mt-1 max-w-sm mx-auto">Mark attendance for workers to view daily records here.</p>
                </td>
              </tr>
            </motion.tbody>
          </table>
