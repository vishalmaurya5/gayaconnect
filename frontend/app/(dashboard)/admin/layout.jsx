...
import { 
  ...
  FiPhoneCall, FiSettings, FiMonitor, FiBriefcase, FiTruck, FiList
} from 'react-icons/fi';
...
export default function AdminLayout({ children }) {
  ...
  const menuItems = [
    ...
    { name: 'Categories', path: '/admin/dashboard/categories', icon: FiList },
  ...
  return (
    <div className="min-h-screen bg-slate-950 px-4 py-10 flex items-center justify-center">
      <form onSubmit={login} className="w-full max-w-md rounded-2xl border border-white/10 bg-slate-900 p-8 shadow-2xl">
        ...
        <p className="mt-2 text-slate-400">Secure access to the Gaya Seva control center.</p>
