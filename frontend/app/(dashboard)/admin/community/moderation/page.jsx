  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">Content Moderation</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage reported content, community guidelines, and user restrictions.</p>
        </div>
      </div>
          ...
          <table className="w-full text-left border-collapse whitespace-nowrap">
            <thead>
              <tr className="bg-white dark:bg-[#0B0F19] border-b border-slate-200 dark:border-slate-800">
                <th className="px-6 py-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Reported Item</th>
                <th className="px-6 py-4 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Report Details</th>
            ...
            >
              <tr>
                <td colSpan="3" className="p-12 text-center">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 mt-1 max-w-sm mx-auto">No flagged or reported content requires moderation.</p>
                </td>
              </tr>
            </motion.tbody>
          </table>
