...
import { ShieldAlert, Search, Filter, Building, Mail, Phone, CheckCircle, XCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div>
        ...
        <p className="text-slate-500 mt-1">Review and approve new vendor registrations for the Gaya Seva marketplace.</p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col">
        <div className="p-5 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
          <div className="relative w-full max-w-sm">
            ...
            <input type="text" placeholder="Search pending applications..." className="w-full pl-9 pr-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm outline-none focus:border-indigo-500" />
          </div>
        ...
        <div className="overflow-x-auto min-h-[400px]">
          {loading ? (
            ...
            <div className="p-12 flex flex-col items-center text-center">
              ...
              <p className="text-slate-500 mt-1">No pending vendor applications to review.</p>
            </div>
          ) : (
                  ...
                  <tr key={vendor._id} className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-amber-50 dark:bg-amber-500/10 flex items-center justify-center text-amber-600 border border-amber-100">
                    ...
                    <td className="px-6 py-4 text-right">
                      {admin?.role === 'SUPER_ADMIN' && (
                        <div className="flex items-center justify-end gap-2">
                          <button onClick={() => approveVendor(vendor._id)} className="px-3 py-1.5 bg-emerald-50 text-emerald-700 hover:bg-emerald-100 rounded-lg text-sm font-bold flex items-center gap-1.5 transition">
