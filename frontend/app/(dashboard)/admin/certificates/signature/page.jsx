  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">Digital Signature</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage digital signatures for official certificates.</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-[#0B0F19] rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-12 text-center">
        ...
        <h3 className="text-xl font-bold text-slate-900 dark:text-white">Authorized Signature</h3>
        <p className="text-slate-500 dark:text-slate-400 mt-2 max-w-md mx-auto mb-6">Upload an authorized signature image (PNG/SVG) to be embedded securely into generated certificates.</p>
        <motion.button 
